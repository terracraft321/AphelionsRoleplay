...
void onInit( CBlob@ this )
{
	...
	if(name == "mat_energyrunes")
	{
	    max = 10;
        set = true;
	} 
	else if(name == "mat_miasmarunes")
	{
	    max = 5;
        set = true;
	}
	else if(name == "mat_lightningrunes")
	{
	    max = 3;
        set = true;
	}
	else if(name == "mat_bombrunes")
	{
	    max = 1;
        set = true;
	}
    else if (name == "mat_arrows" || name == "mat_ironarrows" || name == "mat_steelarrows")
    {
        max = 30;
        set = true;
    }
	else if (name == "mat_piercingarrows")
	{
	    max = 15;
		set = true;
	}
	...
	else if(name == "mat_flour" || name == "mat_coal" || name == "mat_iron" || name == "mat_mythril" || name == "mat_adamantite")
	{
	    max = 100;
		set = true;
	}
	else if(name == "mat_ironbars" || name == "mat_steelbars" || name == "mat_goldbars" || name == "mat_mythrilbars" || name == "mat_adamantbars")
	{
	    max = 10;
		set = true;
	}
	else if(name == "mat_roundshot")
	{
	    max = 15;
		set = true;
	}
