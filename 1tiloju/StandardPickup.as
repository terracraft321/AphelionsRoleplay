...
f32 getPriorityPickupScale( CBlob@ this, CBlob@ b, f32 scale )
{
	...
	{
		if( name == "mat_wood" || name == "mat_stone" || name == "mat_gold" || name == "mat_flour" ||
		    name == "mat_coal" || name == "mat_iron" || name == "mat_mythril" || name == "mat_adamantite" )
		{
			if ( isClassTypeBuilder(thisname) )
			{
				scale *= 0.25f;
			}
			else
		...
		else if( name == "mat_arrows" || name == "mat_ironarrows" || name == "mat_steelarrows" || name == "mat_mythrilarrows" || name == "mat_adamantarrows" ||
	             name == "mat_firearrows"  || name == "mat_bombarrows"  || name == "mat_waterarrows" ||
				 name == "mat_roundshot")
		{
			if ( isClassTypeMarksman(thisname) )
			{
				scale *= 0.25f;
			}
			else
		...
		else if( name == "mat_orbs" || name == "mat_waterorbs" || name == "mat_healingorbs" || name == "mat_bomborbs")
		{
			if ( isClassTypeMage(thisname) )
			{
				scale *= 0.25f;
			}
			else
