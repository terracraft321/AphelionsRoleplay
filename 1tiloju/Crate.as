...
void onInit( CBlob@ this )
{
    ...
    if (this.exists("frame"))
    {
		...
		// GIANT HACK!!!
		if (packed == "catapult" || packed == "bomber" || packed == "ballista" || packed == "mounted_bow" || packed == "longboat" || packed == "warboat" || packed == "caravel")	 // HACK:
		{
...
bool canUnpackHere( CBlob@ this )
{
	...
	string packed = this.get_string("packed");
	bool water = packed == "longboat" || packed == "warboat" || packed == "caravel";	    
	if (this.isAttached())
	{
