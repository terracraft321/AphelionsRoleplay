...
void LoadSprites( CSprite@ this )
{
    string texname = this.getBlob().getSexNum() == 0 ?
                    "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Marksman/Crossbowman/Sprites/HumanCrossbowmanMale.png" :
                    "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Marksman/Crossbowman/Sprites/HumanCrossbowmanFemale.png";
	...
	if(this.getBlob().getTeamNum() == RACE_ORCS)
	{
		texname = this.getBlob().getSexNum() == 0 ?
				 "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Marksman/Crossbowman/Sprites/OrcCrossbowmanMale.png" :
				 "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Marksman/Crossbowman/Sprites/OrcCrossbowmanFemale.png";
	}
	else if(this.getBlob().getTeamNum() == RACE_UNDEAD)
	{
		texname = "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Marksman/Crossbowman/Sprites/UndeadCrossbowman.png";
	}
