...
void DoAttack(CBlob@ this, f32 damage, f32 aimangle, f32 arcdegrees, u8 type, int deltaInt, KnightInfo@ info )
{
	...
	// apply damage modifier of equipped sword
	string sword = getEquipmentSlotItem(this, SLOT_WEAPON);
	
	if (sword == "default_sword")
	    damage *= 1.0f;
	else if(sword == "iron_sword")
	    damage *= 1.25f;
	else if(sword == "steel_sword")
	    damage *= 1.5f;
	else if(sword == "gold_sword")
	    damage *= 1.75f;
	else if(sword == "dragon_sword")
	    damage *= 2.0f;
