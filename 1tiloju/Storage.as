...
{
	bool accessible = forBlob.getTeamNum() == this.getTeamNum() || getGameTime() < getRules().get_u32("lost_war_" + this.getTeamNum() + "_" + forBlob.getTeamNum());

	return (accessible && forBlob.isOverlapping(this));
}
