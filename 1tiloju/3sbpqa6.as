...
void LoadSprites( CSprite@ this )
{
	...
	if(this.getBlob().getTeamNum() == RACE_DWARVES)
	{
		texname = this.getBlob().getSexNum() == 0 ?
				 "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Marksman/Archer/Sprites/DwarfArcherMale.png" :
				 "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Marksman/Archer/Sprites/DwarfArcherFemale.png";
	}
	else if(this.getBlob().getTeamNum() == RACE_ELVES)
	{
		texname = this.getBlob().getSexNum() == 0 ?
				 "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Marksman/Archer/Sprites/ElfArcherMale.png" :
				 "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Marksman/Archer/Sprites/ElfArcherFemale.png";
	}
	else if(this.getBlob().getTeamNum() == RACE_ORCS)
	{
		texname = this.getBlob().getSexNum() == 0 ?
				 "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Marksman/Archer/Sprites/OrcArcherMale.png" :
				 "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Marksman/Archer/Sprites/OrcArcherFemale.png";
	}
	else if(this.getBlob().getTeamNum() == RACE_UNDEAD)
	{
		texname = "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Marksman/Archer/Sprites/UndeadArcher.png";
	}
    ...
    if (arrow !is null)
    {
        ...
        anim.AddFrame(25); //mythril
        anim.AddFrame(29); //adamant
...
void onGib(CSprite@ this)
{
	...
	CParticle@ Body     = makeGibParticle( "Entities/Characters/Classes/Marksman/Archer/ArcherGibs.png", pos, vel + getRandomVelocity( 90, hp , 80 ), 0, 0, Vec2f (16,16), 2.0f, 20, "/BodyGibFall", team );
	CParticle@ Arm      = makeGibParticle( "Entities/Characters/Classes/Marksman/Archer/ArcherGibs.png", pos, vel + getRandomVelocity( 90, hp - 0.2 , 80 ), 1, 0, Vec2f (16,16), 2.0f, 20, "/BodyGibFall", team );
	CParticle@ Shield   = makeGibParticle( "Entities/Characters/Classes/Marksman/Archer/ArcherGibs.png", pos, vel + getRandomVelocity( 90, hp , 80 ), 2, 0, Vec2f (16,16), 2.0f, 0, "Sounds/material_drop.ogg", team );
	CParticle@ Sword    = makeGibParticle( "Entities/Characters/Classes/Marksman/Archer/ArcherGibs.png", pos, vel + getRandomVelocity( 90, hp + 1 , 80 ), 3, 0, Vec2f (16,16), 2.0f, 0, "Sounds/material_drop.ogg", team );
}
