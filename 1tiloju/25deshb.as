...
{
	const ::s32 resheath_time = 3;

	const ::s32 slash_charge = 15;
	const ::s32 slash_charge_level2 = 48;
	const ::s32 slash_charge_limit = slash_charge_level2 + slash_charge + 12;
	const ::s32 slash_move_time = 4;
	const ::s32 slash_time = 13;
	const ::s32 double_slash_time = 8;

	const ::f32 slash_move_max_speed = 3.25f;
...
const f32 DEFAULT_ATTACK_DISTANCE = 20.0f;
const f32 MAX_ATTACK_DISTANCE = 22.5f;
