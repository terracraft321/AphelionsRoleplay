...
const u16 RESPAWN_TIME = 600 * 30;
const f32 YIELD_PROBABILITY = 0.25f;
...
void onInit( CBlob@ this )
{
	...
	this.getCurrentScript().tickFrequency = 36;
}
...
f32 onHit( CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData )
{
	...
	else if(getNet().isServer())
	{
		...
		if  (yield_ore)
		{
		    MakeMat(hitterBlob, worldPoint, "mat_adamantite", 2 * damage);
		}
		else
		{
